...
WebUI.setText(findTestObject('Object Repository/Page_Zack Market/input_Full name_fullname'), 'User Name')

WebUI.click(findTestObject('Object Repository/Page_Zack Market/div_Full nameEmail'))

WebUI.setText(findTestObject('Object Repository/Page_Zack Market/input_Email_email'), email)

String var = WebUI.getText(findTestObject('Page_Zack Market/div_invalid email'), FailureHandling.STOP_ON_FAILURE)
