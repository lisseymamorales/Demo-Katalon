...
WebUI.verifyElementText(findTestObject('Page_Zack Market/div_Required'), 'Required')

WebUI.verifyElementPresent(findTestObject('Page_Zack Market/div_Required'), 0)
